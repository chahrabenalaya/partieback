package com.pfe.faculty.security;
...
import org.springframework.security.config.annotation.method.configuration.EnableGlobalMethodSecuri
...
.antMatchers("/visiteur/ajouter").permitAll()
